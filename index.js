...
client.on('ready', () => {
    ...
    client.user.setActivity(`Cplay`,{type: 'LISTENING'}); ///التعديل علي البلاينج
});
...
**`
  if(message.content === prefix + 'help') {
    ...
    let e = '** جاري الارســال .. :envelope_with_arrow: **'
	  ...
	  message.author.send(helplist).catch(error => message.reply('** لم اتمكن من ارسال الاوامر , يرجى فتح الخاص :negative_squared_cross_mark:**'))
}
});
